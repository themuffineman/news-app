...
const SearchBar: React.FC = () => {
  return (
    <div className=' flex gap-1 shadow rounded-md py-2 pl-2 items-center justify-between bg-gray-50 h-12 outline-1' >
        ...
        <input type="search" placeholder='Search News, Articles and Sources' className='w-96 p-1 px-4 focus:outline-none rounded-lg bg-gray-50' />
        <button className='justify-end font-semibold rounded-r-md w-max h-full p-2 bg-gray-200 border-l-1 text-black' >Search</button>
        </form>
    </div>
  )
}
