...
const SearchBar: React.FC = () => {
  ...
  return (
    <div className=' flex gap-1 shadow rounded-md py-2 pl-2 items-center justify-between bg-gray-50 h-12 outline-1' >
        ...
        <span className='w-full h-12 justify-end flex'>
        ...
        <button className='justify-end hidden sm:block font-semibold rounded-r-md w-max h-full p-2 bg-gray-200 border-l-1 text-black' > <Link to={`search/${searchInput}`} >Search</Link> </button>
        </span>
    </div>
  )
}
