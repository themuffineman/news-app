...
const SearchBar: React.FC = () => {
  return (
    <div className=' flex gap-1 shadow rounded-md py-2 pl-2 items-center justify-between bg-gray-50 h-12 outline-1' >
        ...
        <input type="search" placeholder='Search News, Articles and Sources' className=' w-20 ss:w-24 xs:w-48 sm:w-72 md:w-96 p-1 px-4 focus:outline-none rounded-lg bg-gray-50' />
