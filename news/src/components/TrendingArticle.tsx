...
const TrendingArticle:React.FC = () => {
  return (
    ...
    <div className=' w-[90vw] sm:w-[80vw] h-max  relative rounded-md bg-opacity-5 bg-center bg-cover' style={{backgroundImage: `url(${cavicun})`}}>
        ...
        <div className=' flex flex-col md:flex-row w-full h-full z-20 justify-between gap-5 items-center px-5'>
            <div className=' w-full md:w-1/2 h-full flex justify-between flex-col gap-5 pl-4 my-12'>
                ...
                <h1 className=' text-4xl lg:text-7xl font-bold capitalize  z-20 text-white'>The british are coming</h1>
